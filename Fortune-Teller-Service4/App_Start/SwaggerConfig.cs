...
namespace FortuneTellerService4
{
    ...
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //    .Flow("implicit")
                        //    .AuthorizationUrl("http://login.sys.islands.cloud")
        ...
        /// <summary>
        /// Gets the root URL from application configuration.
        /// </summary>
        /// <param name="req">The req.</param>
        /// <returns></returns>
        public static string GetRootUrlFromAppConfig(HttpRequestMessage req)
        {
            string ret = req.RequestUri.Scheme + "://" + req.RequestUri.Host + ":" + req.RequestUri.Port.ToString();
            Console.WriteLine($"Host: {req.RequestUri.Host}  Scheme: {req.RequestUri.Scheme}");

            if (!req.IsLocal())
            {                
                ret = req.RequestUri.Scheme + "://" + req.RequestUri.Host;
            }

            Console.WriteLine($"Host string set to {ret}");
            return ret;
        }
        ...
        /// 
        /// </summary>
        /// <seealso cref="Swagger.Net.IOperationFilter" />
